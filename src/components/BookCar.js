...
const handleBookButton=async()=>{
   if (isAuthenticated) {
    ...
    const bookedCar = selectCar[0];
        const response = await axios.post(`https://turbotraderapi.onrender.com/bookedCar`, {
          userid: userid,
          bookedCar: bookedCar
        });
  ...
  <>
    <div className="main_bookCar">
      <div className="bookcar_container">
        ...
        {selectCar ? (
          <div className="selected_carContainer">
            ...
            <p>
              ...
              {(price = selectCar[0].car_price)} {selectCar[0].number_of_seats}
              <Icon name="user"></Icon>
            </p>
          </div>
        ) : (
        ...
        <div style={{ color: "black", padding: 10, paddingLeft: 20 }} className='featureDetail'>
      ...
      <div className={ShowBookDetail ? "payment_details" : "payment_details2"}>
