...
const HomeImageSlider = () => {
  ...
  const slide_image = [
    ...
    "https://boit.club/cdn/shop/articles/Your_paragraph_text_5.png?v=1690794931&width=1100",
    "https://i.etsystatic.com/21338436/r/il/c5264c/2516326213/il_570xN.2516326213_6290.jpg",
  ];
  ...
  return (
    <div className="image-slider ">
      <img
        src={slide_image[currentImageIndex]}
