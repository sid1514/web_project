...
const CarList = () => {
  ...
  const handleFavCar = async (car_brand) => {
    ...
    try {
      const response = await axios.post(
        `https://turbotraderapi.onrender.com/favoriteCar`,
        {
          userid,
  ...
  const CarBrands = [
    ...
    },
    {
      ...
      image: {
        avatar: true,
        src: "https://i.pinimg.com/originals/9b/a4/c2/9ba4c2b21c708bfd2bee16a90ad766aa.jpg",
      },
    },
    {
      key: "Lamborgani",
      ...
      image: {
        avatar: true,
        src: "https://w7.pngwing.com/pngs/509/1013/png-transparent-lamborghini-aventador-car-logo-lamborghini-emblem-logo-car.png",
      },
    },
  ];
  return (
    <>
      <div className="button-container">
        ...
        <div className="s_container">
          ...
          />
          <button className="b2" onClick={() => handleCategoryChange("all")}>
            Search
          </button>
        </div>
        <aside className="select_brand">
          <Dropdown
            className="brand_dropdwon"
